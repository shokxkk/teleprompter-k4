    ...
    versions: [
      {
        ...
        payload: {
          title: "📋 [ИНСТРУКЦИЯ] Телесуфлёр k4 - Использование",
          spokenText: `Добро пожаловать в Телесуфлёр k4! [Пауза 1 сек]

[Улыбнитесь!] Вот короткая инструкция как легко читать и снимать отличные видео:

1. [Загрузка файлов]: Нажмите кнопку (+) или перетащите ваш файл Word (.docx), PowerPoint (.pptx), Фото или Текст прямо на экран.

2. [Управление скоростью]: Используйте ползунок WPM или клавиши Стрелка Вверх / Стрелка Вниз для настройки скорости прокрутки.

3. [Маркеры и Подсказки]: Добавляйте в ваш текст подсказки в квадратных скобках:
- [Пауза 2 сек] — выделяется жёлтым цветом
- [Улыбнитесь!] — выделяется зелёным цветом
- [Акцент!] — выделяется красным цветом

4. [Зеркалирование и Поворот]: В меню «Настройки» вы можете перевернуть текст зеркально для суфлёрных стёкол или повернуть на 90 градусов для вертикальных съёмок.

5. [Приватность]: Все ваши документы хранятся [Акцент!] ТОЛЬКО на вашем устройстве и доступны только вам!

[Улыбнитесь!] Нажмите кнопку СТАРТ или Пробел на клавиатуре и начинайте съёмку!`,
        },
      },
    ],
  },
